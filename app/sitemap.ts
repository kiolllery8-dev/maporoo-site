...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const collectionPages: MetadataRoute.Sitemap = shopCollections().map((c) => ({
  ...
  const concernPages: MetadataRoute.Sitemap = shopConcerns().map((c) => ({
  ...
  const ingredientDocs: MetadataRoute.Sitemap = shopIngredientPages().map((i) => ({
