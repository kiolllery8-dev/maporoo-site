...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative z-20 min-h-screen flex flex-col items-center pt-[22vh]">
        <div className="sticky top-[15vh] flex justify-center w-full pointer-events-none">
          <motion.img
