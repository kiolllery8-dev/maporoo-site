  ...
  return (
    <section className="relative py-32 md:py-48 px-6">
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        <FadeIn delay={0.2}>
          <h2 className="font-serif font-light text-3xl md:text-4xl leading-[1.7] text-ink">
            在這個紛擾不休的世代，<br />
        ...
        <FadeIn delay={0.5}>
          <div className="space-y-6 text-ink-soft leading-loose tracking-wider font-light">
            <p>
